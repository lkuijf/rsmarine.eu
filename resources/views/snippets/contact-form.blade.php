...
<form action="/submit-contact-form" method="post" class="contactForm">
    ...
    <div><button type="submit" class="g-recaptcha" data-sitekey="6LdpSX0eAAAAANrVFYR0hn3Lw63hrhK0r04UhOGN" data-callback="onSubmit" data-action="submit"><span>Verzenden</span></button></div>
</form>
